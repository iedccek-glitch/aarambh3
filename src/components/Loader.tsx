...
const Loader = () => {
  ...
  useEffect(() => {
    // Single timer to remove loader from DOM after all animations complete
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center loader-wrapper">
      <div className="absolute inset-0 bg-black loader-bg" />
      <svg
        width="288"
        height="220"
        viewBox="0 0 288 220"
        ...
        className="loader-svg relative z-10"
      >
        <path
