    ...
    >
      <div className='bg-[var(--bg-card)] rounded-2xl overflow-hidden border-2 border-[var(--border-color)] shadow-2xl hover:shadow-appleGreen-400/20 transition-all duration-500 group h-full'>
        <div className='relative overflow-hidden bg-gradient-to-br from-appleGreen-400/5 via-asparagus-400/5 to-yellowGreen-400/5'>
          <img 
            src="/assets/sunday-fun-ticket.png" 
            alt="AARAMBH 3.0 Sunday Fun Ticket"
        ...
        <div className='p-6 lg:p-8 text-center bg-gradient-to-b from-[var(--bg-card)] to-[var(--bg-secondary)]'>
          ...
          <a 
            href="https://konfhub.com/widget/aarambh26?desc=true&secondaryBg=F7F7F7&ticketBg=F7F7F7&borderCl=F7F7F7&bg=FFFFFF&fontColor=1e1f24&ticketCl=1e1f24&btnColor=002E6E&fontFamily=Hind&borderRadius=10&widget_type=standard&tickets=70247&ticketId=70247%7C1"
            target="_blank"
...
SundayFunTicket.displayName = 'SundayFunTicket';

export default SundayFunTicket;
